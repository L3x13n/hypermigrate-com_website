...
/**
 * Rename "Home" menu item to "Homes".
 *
 * @param string $items The HTML list content for the menu items.
 * @param array  $args  An array of arguments.
 * @return string
 */
function hypermigratefull_rename_home_menu_item( $items, $args ) {
    // Check if it's the primary menu and if the 'Home' item exists.
    if ( 'primary' === $args->theme_location ) {
        $items = str_replace( 'Home', 'Homes', $items );
    }
    return $items;
}
add_filter( 'wp_nav_menu_items', 'hypermigratefull_rename_home_menu_item', 10, 2 );
