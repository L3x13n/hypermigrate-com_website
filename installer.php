...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20241210_hypermigratesolutions_28f3adeefce866001255_20250615204404_archive.zip';
        const ARCHIVE_SIZE       = '88432364';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '28f3ade-15204404';
        const SECONDARY_PACKAGE_HASH = '46f3a13-15204404';
